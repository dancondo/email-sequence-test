  ...
  return (
    <div className="space-y-10">
      ...
      <div className="grid grid-cols-1 gap-6 lg:grid-cols-3">
        ...
        <div className="rounded bg-surface-container-lowest p-6 shadow-ambient">
          ...
          <button
            onClick={onConnect}
            disabled={isPending}
            className="w-full rounded bg-gradient-to-br from-primary to-primary-container px-4 py-2.5 text-sm font-medium text-on-primary hover:opacity-90 disabled:opacity-50"
          >
            {isPending ? "Redirecting..." : "Connect Gmail →"}
          </button>
          <p className="mt-4 text-xs text-outline">
            You can disconnect your account at any time from the Settings panel.
          </p>
        </div>
      </div>
    </div>
